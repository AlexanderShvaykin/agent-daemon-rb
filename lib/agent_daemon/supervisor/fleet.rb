...
module AgentDaemon
  module Supervisor
    ...
    class Fleet
      ...
      Entry = Struct.new(:kind, :workflow, :name, :status, :liveness, keyword_init: true)
      ...
      def initialize(roster:, state_registry:)
      ...
      def entries
        ...
        @roster.map do |rostered|
          snapshot = snapshots[rostered.entity_id]
